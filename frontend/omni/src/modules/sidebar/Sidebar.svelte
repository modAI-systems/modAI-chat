...
const userItem = $derived(
    modules.getOne<SidebarUserItem>(SIDEBAR_USER_ITEM_TYPE),
);
</script>

<AppSidebar side="right" settingItems={settingItems} {userItem} />
